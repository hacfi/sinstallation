...
function install_alfred {
  install_compressed_app "http://cachefly.alfredapp.com/Alfred_2.3_264.zip" "Alfred 2.app"
}
...
function install_little_snitch {
  install_disk_image_with_installer "http://www.obdev.at/downloads/LittleSnitch/LittleSnitch-3.3.1.dmg" "Little Snitch Configuration.app" "Little Snitch Installer.app/Contents/MacOS/Little Snitch Installer"
}
